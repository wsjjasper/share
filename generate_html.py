            ...
            <div class="glass-card rounded-2xl p-6 shadow-sm border border-slate-200 flex flex-col justify-between">
                <div>
                    ...
                    <p class="text-sm text-slate-600 leading-relaxed mb-4">
                        基于 <strong>万得全A (881001.WI)</strong> 核心高频行情与交易数据，选取涵盖“交易热度、结构集中度、广度效应、杠杆博弈”四个维度的核心指标，消除绝对值随市场体量扩张的量纲漂移。
                    </p>
                        ...
                        <table class="w-full text-left text-xs text-slate-600">
                            ...
                            <tbody class="divide-y divide-slate-100 bg-white">
                                <tr class="hover:bg-slate-50">
                                    ...
                                    <td class="px-3 py-2.5 font-mono">万得全A换手率 (%)</td>
                                    <td class="px-3 py-2.5">反映全市场交投活跃度与筹码换手意愿</td>
                                </tr>
                                <tr class="hover:bg-slate-50">
                                    <td class="px-3 py-2.5 font-bold text-slate-900">2</td>
                                    <td class="px-3 py-2.5 font-semibold text-amber-600">前3行业成交占比</td>
                                    <td class="px-3 py-2.5 font-mono">前三行业成交额 / 总成交额</td>
                                    <td class="px-3 py-2.5">反映市场主线资金抱团集中度与分化程度</td>
                                </tr>
                                <tr class="hover:bg-slate-50">
                                    <td class="px-3 py-2.5 font-bold text-slate-900">3</td>
                                    <td class="px-3 py-2.5 font-semibold text-emerald-600">上涨个股占比</td>
                                    <td class="px-3 py-2.5 font-mono">上涨家数 / 样本成份总数</td>
                                    <td class="px-3 py-2.5">反映市场广度与普遍赚钱效应（普涨 vs 普跌）</td>
                                </tr>
                                <tr class="hover:bg-slate-50">
                                    <td class="px-3 py-2.5 font-bold text-slate-900">4</td>
                                    <td class="px-3 py-2.5 font-semibold text-rose-600">融资买入额占比</td>
                                    <td class="px-3 py-2.5 font-mono">融资买入额 / 总成交额</td>
                                    <td class="px-3 py-2.5">反映高风险偏好杠杆资金对后市的进攻情绪</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="mt-4 p-3 bg-amber-50/70 border border-amber-200/80 rounded-xl text-xs text-amber-800">
                    <strong>💡 数据处理说明：</strong>
                    融资买入数据自 2010-03-31 起开始发布。当遇到最新交易日融资数据尚未更新发布（或缺失）时，算法自动采用其余有效指标的平均分位数进行无偏合成。
                </div>
            </div>
            ...
            <div class="glass-card rounded-2xl p-6 shadow-sm border border-slate-200 flex flex-col justify-between">
                <div>
                    ...
                    <div class="space-y-4 text-sm text-slate-600">
                        <div>
                            <h3 class="font-semibold text-slate-800 text-xs uppercase tracking-wider mb-1.5">1. 滚动252个交易日分位数排名 (Percentile Rank)</h3>
                            <div class="bg-slate-900 text-slate-100 p-3.5 rounded-xl text-xs overflow-x-auto">
                                $$\text{Percentile}_{i,t} = \frac{\text{Count}(X_{i} < X_{i,t}) + 0.5 \times \text{Count}(X_{i} = X_{i,t})}{N_{\text{valid}}} \times 100$$
                            </div>
                            <p class="text-xs text-slate-500 mt-1">其中窗口大小为 past 252 交易日（约1年），消除不同市场历史时期的绝对数值中枢差异。</p>
                        </div>

                        <div>
                            <h3 class="font-semibold text-slate-800 text-xs uppercase tracking-wider mb-1.5">2. 综合情绪指标等权合成 (Equal Weighted Composite)</h3>
                            <div class="bg-slate-900 text-slate-100 p-3.5 rounded-xl text-xs overflow-x-auto">
                                $$\text{Sentiment}_t = \frac{1}{M_t} \sum_{i=1}^{M_t} \text{Percentile}_{i,t}$$
                            </div>
                            <p class="text-xs text-slate-500 mt-1">综合指标取值区间 0 ~ 100，反映当前市场情绪在过去一年的相对水位。</p>
                        </div>

                        <div class="grid grid-cols-3 gap-2 pt-2 text-center text-xs">
                            <div class="p-2.5 rounded-xl bg-red-50 border border-red-200">
                                <div class="font-bold text-red-700">> 80 分位</div>
                                <div class="text-red-600 mt-0.5">过热区间 / 警惕回撤</div>
                            </div>
                            <div class="p-2.5 rounded-xl bg-slate-100 border border-slate-200">
                                <div class="font-bold text-slate-700">20 ~ 80 分位</div>
                                <div class="text-slate-600 mt-0.5">中性震荡 / 结构市</div>
                            </div>
                            <div class="p-2.5 rounded-xl bg-emerald-50 border border-emerald-200">
                                <div class="font-bold text-emerald-700">< 20 分位</div>
                                <div class="text-emerald-600 mt-0.5">极度冷清 / 酝酿底部</div>
                            </div>
                        </div>
                    </div>
                </div>
